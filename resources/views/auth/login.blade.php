...
<body>
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="row g-3 needs-validation" method="POST"
                                        action="{{ route('loginProses') }}" novalidate>
                                        @csrf
                                        <div class="col-12">
    ...
    <!-- Vendor JS Files -->
    <script src="{{ asset('backend_template/assets/vendor/apexcharts/apexcharts.min.js') }}"></script>
    <script src="{{ asset('backend_template/assets/vendor/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
    <script src="{{ asset('backend_template/assets/vendor/chart.js/chart.min.js') }}"></script>
    <script src="{{ asset('backend_template/assets/vendor/echarts/echarts.min.js') }}"></script>
    <script src="{{ asset('backend_template/assets/vendor/quill/quill.min.js') }}"></script>
    <script src="{{ asset('backend_template/assets/vendor/simple-datatables/simple-datatables.js') }}"></script>
    <script src="{{ asset('backend_template/assets/vendor/tinymce/tinymce.min.js') }}"></script>
